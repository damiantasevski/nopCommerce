...
public partial class SampleProducts
{
    ...
    public partial class SampleProduct
    {
        ...
        /// </summary>
        public int StockQuantity { get; set; } = 10000;
        ...
        /// </summary>
        public int NotifyAdminForQuantityBelow { get; set; } = 1;
        ...
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public LowStockActivity LowStockActivity { get; set; } = LowStockActivity.DisableBuyButton;
