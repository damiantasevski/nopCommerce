...
public partial class SampleManufacturer
{
    ...
    /// </summary>
    public decimal PriceFrom { get; set; } = NopCatalogDefaults.DefaultPriceRangeFrom;

    /// <summary>
    /// Gets or sets the "to" price
    /// </summary>
    public decimal PriceTo { get; set; } = NopCatalogDefaults.DefaultPriceRangeTo;

    /// <summary>
    /// Gets or sets a value indicating whether the price range should be entered manually
    /// </summary>
    public bool ManuallyPriceRange { get; set; } = true;
}
